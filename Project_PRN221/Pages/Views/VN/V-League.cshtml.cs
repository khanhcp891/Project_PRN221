...
namespace Project_PRN221.Pages.Views.VN
{
    public class V_LeagueModel : PageModel
    {
        ...
        public V_LeagueModel(PRN221_SP23Context dbContext)
        {
            this.dbContext = dbContext;
        }
        public void OnGet()
        {
            listPost = dbContext.Posts.Where(x => x.IdCategory == 2).ToList();
