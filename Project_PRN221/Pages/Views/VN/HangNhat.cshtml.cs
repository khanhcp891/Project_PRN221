...
namespace Project_PRN221.Pages.Views
{
    public class HangNhatModel : PageModel
    {
        ...
        public HangNhatModel(PRN221_SP23Context dbContext)
        {
            this.dbContext = dbContext;
        }
        public void OnGet()
        {
            listPost = dbContext.Posts.Where(x => x.IdCategory == 3).ToList();
