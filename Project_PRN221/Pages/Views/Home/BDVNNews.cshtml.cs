...
{
    public class BDVNNewsModel : PageModel
    {
        ...
        public BDVNNewsModel(PRN221_SP23Context context)
        {
            this.dbContext = context;
        }
        public void OnGet()
        {
            listPost = dbContext.Posts.Where(x => x.IdCategory <5 && x.IdCategory > 0).ToList();
            ...
            listPostShow = listPost.Skip((currentPage - 1) * 4).Take(ITEM_PER_PAGE).ToList();
